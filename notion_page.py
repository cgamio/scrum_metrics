...
from notion.block import PageBlock, HeaderBlock
...
class NotionPage:
    ...
    def createSprintReport(self, sprint_data):
        ...
        sprint_report.children.add_new(HeaderBlock, title=f"[{sprint_data['project_name']} Sprint {sprint_data['sprint_number']} Report ({date_string})]('https://www.google.com')")
